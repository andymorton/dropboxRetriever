...
public class FilterTester 
{
    ...
    protected static final Log m_logger = LogFactory.getLog(FilterTester.class);
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            final FileFilter ff = (FileFilter) ctx.getBean(filter);

            //Run the filter
            Map returnFile = ff.process(fileMap);
